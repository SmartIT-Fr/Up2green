...
class Version20131126220110 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        // Users
        $this->addSql("ALTER TABLE fos_user ADD credit DOUBLE PRECISION NOT NULL, ADD accept_newsletter TINYINT(1) NOT NULL, ADD locale VARCHAR(7) NOT NULL, ADD discriminator VARCHAR(255) NOT NULL, CHANGE username username VARCHAR(255) NOT NULL, CHANGE username_canonical username_canonical VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE email_canonical email_canonical VARCHAR(255) NOT NULL, CHANGE enabled enabled TINYINT(1) NOT NULL, CHANGE locked locked TINYINT(1) NOT NULL, CHANGE expired expired TINYINT(1) NOT NULL, CHANGE credentials_expired credentials_expired TINYINT(1) NOT NULL, CHANGE roles roles LONGTEXT NOT NULL COMMENT '(DC2Type:array)'");
        $this->addSql("UPDATE `fos_user` u INNER JOIN partner p ON p.user_id = u.id SET u.`discriminator` = 'partner'");
        $this->addSql("UPDATE `fos_user` SET `discriminator` = 'user' WHERE `discriminator` IS NULL");
        $this->addSql("DROP INDEX partner_U_1 ON partner");
        $this->addSql("ALTER TABLE partner DROP user_id, CHANGE id id INT NOT NULL, CHANGE title title VARCHAR(255) NOT NULL");
        $this->addSql("ALTER TABLE partner ADD CONSTRAINT FK_312B3E16BF396750 FOREIGN KEY (id) REFERENCES fos_user (id) ON DELETE CASCADE");
        ...
        $this->addSql("CREATE TABLE organization (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(128) NOT NULL, title VARCHAR(128) NOT NULL, summary LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, logo VARCHAR(128) NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, summary LONGTEXT NOT NULL, description LONGTEXT NOT NULL, logo VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE article_i18n (id INT AUTO_INCREMENT NOT NULL, object_id INT DEFAULT NULL, locale VARCHAR(8) NOT NULL, object_class VARCHAR(255) NOT NULL, field VARCHAR(32) NOT NULL, foreign_key VARCHAR(64) NOT NULL, content LONGTEXT DEFAULT NULL, INDEX IDX_4F149F97232D562B (object_id), INDEX article_i18n_idx (locale, object_class, field, foreign_key), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("ALTER TABLE article_i18n ADD CONSTRAINT FK_4F149F97232D562B FOREIGN KEY (object_id) REFERENCES article (id) ON DELETE CASCADE");
